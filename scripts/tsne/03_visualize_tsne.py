...
class EmbeddingVisualizer:
    ...
    def load_embeddings(self, max_per_game: Optional[int] = None, sample_randomly: bool = True) -> Tuple[np.ndarray, np.ndarray, List[str]]:
        """
    ...
    def apply_tsne(self, embeddings: np.ndarray, perplexity: int = 30, max_iter: int = 1000,
                   learning_rate: str = 'auto', random_state: int = 42) -> np.ndarray:
        """
    ...
    def plot_matplotlib(self, embeddings_2d: np.ndarray, labels: np.ndarray, 
                       save_path: str = "tsne_visualization.png", figsize: Tuple[int, int] = (12, 8)):
        """
    ...
    def plot_plotly(self, embeddings_2d: np.ndarray, labels: np.ndarray, paths: List[str],
                   save_path: str = "tsne_interactive.html"):
        """
...
def main():
    ...
    parser.add_argument("--max-per-game", type=int, default=None,
                       help="Maximum number of embeddings per game (default: all)")
    parser.add_argument("--perplexity", type=int, default=30,
                       help="t-SNE perplexity parameter")
    parser.add_argument("--max-iter", type=int, default=1000,
                       help="Maximum number of t-SNE iterations")
    parser.add_argument("--pca-components", type=int, default=50,
                       help="Number of PCA components for pre-processing")
    parser.add_argument("--output-dir", default="./visualizations",
                       help="Directory to save visualizations")
    parser.add_argument("--no-pca", action="store_true",
                       help="Skip PCA preprocessing")
    parser.add_argument("--no-interactive", action="store_false", 
                       help="Skip interactive Plotly visualization")
    ...
    # Load embeddings
    embeddings, labels, paths = visualizer.load_embeddings(
    ...
    # Apply t-SNE
    embeddings_2d = visualizer.apply_tsne(
        embeddings,
