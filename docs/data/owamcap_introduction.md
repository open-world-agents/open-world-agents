...
**Desktop screen capture at 1920×1080 resolution:**

| Format | Size per Frame | 1 Hour (30 FPS) | Compression Ratio |
|--------|----------------|------------------|-------------------|
| **Raw BGRA** | 8.3 MB | 896 GB | 1:1 (baseline) |
| **H.264 Video** | 42 KB avg | 4.5 GB | 198:1 |
| **H.265 Video** | 21 KB avg | 2.3 GB | 390:1 |

**Key advantages:**

- **Lightweight MCAP**: Fast to parse, transfer, and backup
- **Video Compression**: Leverage mature, hardware-accelerated codecs
- **Selective Loading**: Access only needed frames without decompressing entire video
- **Standard Tools**: Preview with any video player, edit with standard software
