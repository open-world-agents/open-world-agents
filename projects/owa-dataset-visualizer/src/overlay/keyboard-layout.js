/**
 * Keyboard layout configuration for overlay rendering
 * @module overlay/keyboard-layout
 */

/**
 * Keyboard layout definition matching convert_overlay.py
 * Each entry: [row, col, width, label, vkCode, isArrow]
 * @type {Array<[number, number, number, string, number, boolean]>}
 */
...
/**
 * Maps generic VK codes to their left/right specific versions
 * Used to highlight both L/R keys when generic modifier is pressed
