...
class BaseEventEncoder(ABC):
    ...
    def encode(self, raw_event: Dict[str, Any]) -> Tuple[Any, List[Union[ScreenEmitted, Dict]]]:
        ...
        Returns:
            Tuple containing:
                - Any: Encoded representation (format depends on encoder)
    ...
    def decode(
        ...
        Args:
            encoded_data: Encoded representation (format depends on encoder)
    ...
    def encode_batch(
    ...
    ) -> Tuple[Any, List[List[Union[ScreenEmitted, Dict]]]]:
        """
        ...
        Returns:
            Tuple containing:
                - Any: Batch of encoded representations
    ...
    def decode_batch(
        ...
        Args:
            encoded_batch: Batch of encoded representations
