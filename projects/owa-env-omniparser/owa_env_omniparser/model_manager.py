...
class ModelManager:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        """
        self.config_path = config_path or os.getenv("OMNIPARSER_CONFIG_PATH", "~/.owa/models/omniparser.json")
        self.config_path = Path(self.config_path).expanduser()
        self.config_path.parent.mkdir(parents=True, exist_ok=True)

        self.model_dir = Path(os.getenv("OMNIPARSER_MODEL_DIR", "~/.owa/models/omniparser")).expanduser()
