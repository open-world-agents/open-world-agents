...
def activate_omniparser():
    ...
    env_vars_to_reset = [
        "OMNIPARSER_MODE", "OMNIPARSER_API_URL", "OMNIPARSER_SOURCE_PATH",
        "OMNIPARSER_FALLBACK_ENABLED", "OMNIPARSER_USE_CACHE",
        "OMNIPARSER_SOM_MODEL_PATH", "OMNIPARSER_CAPTION_MODEL_PATH",
        "OMNIPARSER_DEVICE", "OMNIPARSER_CONFIG_PATH", "OMNIPARSER_MODEL_DIR"
    ]
